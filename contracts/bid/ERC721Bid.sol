...
contract ERC721Bid is Ownable, Pausable, ERC721BidStorage {
    ...
    */
        ...
        whenNotPaused()
    {
        ...
        uint256 expirationDate = block.timestamp.add(_duration);
    ...
    */
        ...
        returns (bytes4)
    {
        ...
        require(
            ...
            bid.id == bidId &&
            bid.expirationDate >= block.timestamp, 
            "Invalid bid"
        );
    ...
    */
        ...
        ) 
    {
        ...
        (bidId, bidder, price, expirationDate) = getBidByToken(_tokenAddress, _tokenId, bidIndex);
        if (_bidder != bidder) {
